...
<%ArrayList<Dispositif_strategique> ds = (ArrayList<Dispositif_strategique>)request.getAttribute("ds"); %>
						...
						<div class="nk-content-inner">
								...
								<div class="nk-block-head nk-block-head-sm">
									<div class="nk-block-between">
										<div class="nk-block-head-content">
											<h1 class="nk-block-title page-title">Dispositif Strategique</h1>
											...
											<table id="table_id"
												...
												<tbody>
													<%for(Dispositif_strategique cc : ds){ 
														String etat = "";
													if(cc.getVisible()==0){
														etat="Dispositif Invisible";
													}else{
														etat="Dispositif Visible";
													}
													%>
							...
							<div class="col-lg-7 offset-lg-5">
								<div class="form-group mt-2">
									<button name="newUser"
										class="btn btn-lg btn-primary " data-toggle="modal" data-target="#modalLarge"><em class="icon ni ni-plus"></em> Nouveau Dispositif </button>
								</div>
							</div>
						</div>
								<!-- nk-block -->
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Nouveau dispositif stratégique</h5>
						...
						<div class="row g-3 align-center">
							<div class="col-lg-5">
								<div class="form-group">
									<label class="form-label">Titre du dispositif stratégique :</label>
								</div>
							</div>
							<div class="col-lg-7">
								<div class="form-group">
