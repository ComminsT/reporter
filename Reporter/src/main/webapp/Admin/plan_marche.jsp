...
<%ArrayList<Plan_marche> ds = (ArrayList<Plan_marche>)request.getAttribute("pm"); %>
						...
						<div class="nk-content-inner">
								...
								<div class="nk-block-head nk-block-head-sm">
									<div class="nk-block-between">
										<div class="nk-block-head-content">
											<h1 class="nk-block-title page-title">Plan de marché</h1>
							...
							<div class="col-lg-7 offset-lg-5">
								<div class="form-group mt-2">
									<button name="newUser"
										class="btn btn-lg btn-primary " data-toggle="modal" data-target="#modalLarge"><em class="icon ni ni-plus"></em> Nouveau plan de marché</button>
								</div>
							</div>
						</div>
								<!-- nk-block -->
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Nouveau plan de marché</h5>
						...
						<div class="row g-3 align-center">
							<div class="col-lg-5">
								<div class="form-group">
									<label class="form-label">Titre du plan de marché :</label>
								</div>
							</div>
							<div class="col-lg-7">
								<div class="form-group">
