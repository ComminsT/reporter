								...
								<div class="nk-block nk-block-lg">
									...
									<a
										href="marketcom/Index?semaine=<%=previousweek %>&year=<%=previousyear%>"><btn
											...
											class="icon ni ni-chevron-left"></em> <span>Année précédente</span></btn></a> <a
										href="marketcom/Index?semaine=<%=nextweek %>&year=<%=nextyear%>">
										<btn class="btn btn-primary"> </em> <span>Année suivante</span> <em class="icon ni ni-chevron-right"></em> </btn>
									</a>
									<!-- Debut tableau -->
																	...
																	<div class="drodown">
																		...
																		<div class="dropdown-menu dropdown-menu-right">
																			<ul class="link-list-opt no-bdr">
																				<li><a href="MarketCom/Details?action=<%=a.getId()%>"><em class="icon ni ni-eye"></em><span>Détails</span></a></li>
																				<li><a href="MarketCom/Modification?id=<%=a.getId()%>"><em class="icon ni ni-edit"></em><span>Modification</span></a></li>
																				<%if(a.getType()==1){ %>
																				<li><a href="MarketCom/Reportingmc?id=<%=a.getId()%>"><em
																						class="icon ni ni-activity-round"></em><span>Reporting</span></a></li>
																			<%}else{ %>
																			
																			<li><a href="MarketCom/Reportingc?id=<%=a.getId()%>"><em
																						class="icon ni ni-activity-round"></em><span>Reporting</span></a></li>
																						<%} %>
