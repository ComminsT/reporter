...
<%ArrayList<Type> ds = (ArrayList<Type>)request.getAttribute("types"); %>
						...
						<div class="nk-content-inner">
								...
								<div class="nk-block-head nk-block-head-sm">
									<div class="nk-block-between">
										<div class="nk-block-head-content">
											<h1 class="nk-block-title page-title">Types</h1>
							...
							<div class="col-lg-7 offset-lg-5">
								<div class="form-group mt-2">
									<button name="newUser"
										class="btn btn-lg btn-primary " data-toggle="modal" data-target="#modalLarge"><em class="icon ni ni-plus"></em> Nouveau Type</button>
								</div>
							</div>
						</div>
								<!-- nk-block -->
						...
						<div class="row g-3 align-center">
							<div class="col-lg-5">
								<div class="form-group">
									<label class="form-label">Titre du Type :</label>
								</div>
							</div>
							<div class="col-lg-7">
								<div class="form-group">
