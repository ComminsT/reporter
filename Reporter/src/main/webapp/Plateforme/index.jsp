...
<body class="nk-body bg-lighter npc-default has-sidebar ">
						...
						<div class="nk-content-inner">
							<div class="nk-content-body">
								...
								<div class="nk-block nk-block-lg">
									...
									%>
									<a
										href="Plateforme/Index?semaine=<%=previousweek %>&year=<%=previousyear%>"><btn
											class="btn btn-primary"> <em
											class="icon ni ni-chevron-left"></em> <span>Semaine
											Précédente</span></btn></a> <a
										href="Plateforme/Index?semaine=<%=nextweek %>&year=<%=nextyear%>">
	...
	<%for ( Action a : actions){ %>
	<div class="modal fade" tabindex="-1" id="modalLarge<%=a.getId()%>">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Finalisation du reporting pour : <%=a.getTheme() %></h5>
					...
					<form method="POST" class="gy-3" data-parsley-validate="">
						<div class="col-lg-12">
							<div class="form-group" align="center">
								<p class="form-label">Êtes-vous sur de vouloir terminer le reporting de
									cette action ?</p>
							</div>
						</div>
						<div class="row g-3">
							<div class="col-lg-7 offset-lg-5">
								<div class="form-group mt-2">
									<button name="terminer<%=a.getId()%>"
										class="btn btn-lg btn-primary">Finaliser</button>
								</div>
							</div>
						</div>
